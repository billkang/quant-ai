...
- [x] 1.1 安装 langchain, langgraph 依赖
- [x] 1.2 更新 requirements.txt

## 2. LangChain 集成

- [x] 2.1 创建 AI 服务基类
- [x] 2.2 实现 DeepSeek/LLM 提供商适配器
- [x] 2.3 测试基本连接
...
- [x] 4.1 创建 diagnostic_history 表
- [x] 4.2 实现 CRUD 操作
- [x] 4.3 添加历史查询 API

## 5. API 集成

- [x] 5.1 创建 /api/ai/analyze/v2 端点
- [x] 5.2 创建 /api/ai/history 端点
- [x] 5.3 保留向后兼容的旧端点

## 6. 前端更新

- [x] 6.1 更新 AIAdvice 组件支持新 API
- [x] 6.2 添加诊断历史展示
- [x] 6.3 测试完整流程
